...
function pogody(){
	...
	/*Typed js*/
	$("#typed").typed({
		strings: [" Geospatial Data and Analytics", " 20 Satellite Datasets", " Statistical Summary Analysis ", " Topological Analysis ", " Chainlink Data Oracle ", " Developer Tools "],
		typeSpeed: 100,
		backDelay: 1200,
		loop: true,
		cursorChar: "|",
	...
	$("#title").typed({
		strings: ["Countries Update", "Regions Update", "Districts Update", "Towns Update", "Town Boundaries", "Roads"],
		typeSpeed: 300,
		backDelay: 900,
		loop: true,
		cursorChar: "|",
